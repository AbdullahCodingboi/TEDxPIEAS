            ...
            {[
              {
                ...
                description: "Check-in, collect your badge, and mingle with fellow attendees over refreshments"
              },
              {
                time: "10:00 AM",
                title: "Opening Ceremony",
                description: "Welcome address and introduction to TEDxPIEAS vision and theme"
              },
              {
                time: "10:30 AM",
                title: "Session 1: Innovation & Technology",
                description: "Four inspiring talks exploring cutting-edge innovations and future technologies"
              },
              {
                time: "12:30 PM",
              ...
              {
                time: "02:00 PM",
                title: "Session 2: Society & Culture",
                description: "Four compelling talks on social impact, culture, and human experiences"
              },
              {
                time: "04:00 PM",
                title: "Tea Break & Interactive Session",
                description: "Refreshments and opportunity for Q&A with speakers"
              },
              {
                time: "04:30 PM",
                title: "Session 3: Future & Possibilities",
                description: "Final session with visionary talks about tomorrow's possibilities"
              },
              {
                time: "06:00 PM",
                title: "Closing Ceremony",
                description: "Wrap-up, thank you notes, and networking reception"
              }
            ].map((item, idx) => (
              <motion.div
                key={idx}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/" className="text-white hover:text-[#ff0000] transition-colors text-sm">Home</a></li>
